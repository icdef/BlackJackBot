package game_control_files;


import playing_cards.Card;
import playing_cards.DeckUtility;
...
public class GameActionsButton {
    ...
    /**
     * Creates embed of the current round. Active PlayerEntity.Player also have "active" next to his/her name
     */
    ...
    public void setUp() {
        ...
        // for debugging
        /*PlayerEntity.Player[] playerTestArray = players.toArray(new PlayerEntity.Player[0]);
    ...
    public void dealerPlay() {
        if (activePlayer != dealer) {
            throw new IllegalStateException("Active PlayerEntity.Player should be dealer right now");
        }
        if (allHadBlackjack){
    ...
    /**
     * PlayerEntity.Player gets another card. Prints the current round state afterwards
     *
    ...
    /**
     * PlayerEntity.Player stands. Prints the current round state afterwards
     *
     * @return true when all players played. Otherwise false
     */
    ...
    /**
     * PlayerEntity.Player gets another card and doubles his/her bet. Prints the current round state afterwards
     *
     * @return true when all players played. Otherwise false
     */
    ...
    /**
     * PlayerEntity.Player splits his/her hand. PlayerEntity.Player will be put into the game as playerName split right after the first hand, so he/she can play both of the hands subsequently. Prints the current round state afterwards
     */
    public void split() {
        Hand activePlayerCurrentHand = activePlayer.getCurrentHand();
        activePlayer.reduceMoney(activePlayer.getBetAmount());
